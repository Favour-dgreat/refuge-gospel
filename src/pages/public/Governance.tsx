                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                "Office of The Inter - Continental pastor",
                                ...
                                <div key={i} className="flex items-center gap-6 p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Workforces", "Executives", "Registered Members", "Members"].map((member, i) => (
                                    <span key={i} className="px-4 py-2 rounded-lg border border-gray-200 text-gray-600 text-sm font-bold uppercase">
                                        {member}
                                    </span>
                                ))}
                            </div>
